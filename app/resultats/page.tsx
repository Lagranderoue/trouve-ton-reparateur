    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-6">
        <div className="flex items-center gap-3 mb-4">
          <a href="/" className="text-sm text-gray-400">← Retour</a>
        ...
        <div className="flex flex-col gap-3">
          {reparateurs.map((r) => (
            <a href={`/reparateur/${r.id}`} key={r.id} className="bg-white border border-gray-100 rounded-xl p-4 flex items-center gap-4">
